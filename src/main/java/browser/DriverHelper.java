...
public class DriverHelper {
    ...
    public WebDriver initDriver() throws IOException {
        ...
        properties.load(new FileInputStream("src/test/resources/browser.properties.txt"));
        ...
        switch (browserType) {
            ...
            case YANDEX:
                ...
                options.setBinary("C://Users//Alexander//AppData//Local//Yandex//YandexBrowser//Application//browser.exe");
